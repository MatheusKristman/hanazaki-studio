  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative w-12 h-5 sm:w-20 sm:h-9 lg:w-36 lg:h-14"
      >
        <Image
          src="/images/gvc.svg"
      ...
      <motion.div
        variants={TradesAnimation}
        className="relative w-14 h-4 sm:w-28 sm:h-6 lg:w-44 lg:h-10"
      >
        <Image
      ...
      <motion.div
        variants={TradesAnimation}
        className="relative w-14 h-3 sm:w-32 sm:h-5 lg:w-36 lg:h-9"
      >
        <Image
